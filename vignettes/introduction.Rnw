...
<<using-SpaDES, eval=FALSE, echo=TRUE, fig=TRUE>>=
library(SpaDES)
...
<<fire, eval=FALSE, echo=TRUE, fig=FALSE>>=
...
<<fire-overlaid, eval=FALSE, echo=TRUE, fig=TRUE>>=
...
<<fire-impacts, eval=FALSE, echo=TRUE, fig=FALSE>>=
# Show the burning more strongly over abundant pine
...
<<fire-impacts-maps, eval=FALSE, echo=TRUE, fig=TRUE>>=
...
<<agent-crw-trajectory, eval=FALSE, echo=TRUE, fig=TRUE>>=
