...
<<checkpoints, echo=TRUE, eval=FALSE>>=
...
source(normalizePath("../inst/sampleModules/randomLandscapes.R"), echo=TRUE, max.deparse.length=10000)
@
...
source(normalizePath("../inst/sampleModules/fireSpread.R"), echo=TRUE, max.deparse.length=10000)
@
...
source(normalizePath("../inst/sampleModules/caribouMovement.R"), echo=TRUE, max.deparse.length=10000)
@
