...
source(normalizePath("../SAMPLE/habitat.R"), echo=TRUE, max.deparse.length=10000)
@
...
source(normalizePath("../SAMPLE/fire.R"), echo=TRUE, max.deparse.length=10000)
@
...
source(normalizePath("../SAMPLE/caribou.R"), echo=TRUE, max.deparse.length=10000)
@
