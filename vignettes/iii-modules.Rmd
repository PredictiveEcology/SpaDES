...
There are a number of built-in modules that provide useful functionality such as plotting and saving. These modules have their names prefaced with a dot (`.`). Parameter values for core modules can be accessed either by using their accessor methods (below); however, these are simply entries in a nested list exactly like the parameters passed to user modules.

These core modules are summarized in the following table and described further below.

**Module Name**   | **Description** | **Parameterization** | **Accessor Methods**
------------------|-----------------|----------------------|---------------------
**`.checkpoint`** | brief summary   | `file`: character.   | `simCheckpointFile()`
&nbsp;            |                 | `interval`: numeric (or `NA`). | `simCheckpointInterval()`
&nbsp;            | &nbsp;          | &nbsp;               | &nbsp;
**`.load`**       | brief summary   | `fileList`: character. | `simFileList()`
&nbsp;            | &nbsp;          | &nbsp;               | &nbsp;
**`.plot`**       | brief summary   | `.plotInitialTime`: numeric (or `NA`) | as list item in your module params.
&nbsp;            |                 | `.plotInterval`: numeric (or `NA`) | as list item in your module params.
&nbsp;            | &nbsp;          | &nbsp;               | &nbsp;
**`.progress`**   | brief summary   | `graphical`: logical (or `NA`). | `simProgressGraphical()`
&nbsp;            |                 | `interval`: numeric (or `NA`). | `simProgressInterval()`
&nbsp;            | &nbsp;          | &nbsp;               | &nbsp;
**`.save`**       | brief summary   | `.saveInitialTime`: numeric (or `NA`) | as list item in your module params.
&nbsp;            |                 | `.saveInterval`: numeric (or `NA`) | as list item in your module params.
&nbsp;            |                 | `.saveObjects`: character | as list item in your module params.
&nbsp;            |                 | `.savePath`: character | as list item in your module params.
