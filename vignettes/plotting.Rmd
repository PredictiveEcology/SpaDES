...
## Layer types
Its main purpose is to plot spatial type objects. Specifically, it currently can plot RasterLayers, RasterStacks, SpatialPoints*, and SpatialPolygons* objects. 
...
Plot(landscape, caribou, DEM, new=TRUE)
```
...
system.time(Plot(landscape, caribou, DEM, speedup=100, new=TRUE))
# can add a new plot to the plotting window
```
