...
output:
  ...
  pdf_document:
    toc: yes
vignette: |
  %\VignetteEngine{knitr::knitr} %\VignetteIndexEntry{03 Plotting with SpaDES} %\VignetteDepends{ggplot2, igraph, RColorBrewer, SpaDES} %\VignetteKeyword{visualization, plotting, mapping} %\usepackage[utf8]{inputenc}
---
