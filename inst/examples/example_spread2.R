...
#  This tests whether the null model of is true ... there should be proportions
#  equivalent to 1:2:3:4:6:7:8:9 ... i.e,. cell 9 should have 9x as many events spread to it as cell 1
keep <- c(1:4,6:9)
