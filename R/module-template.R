...
", name, "Event1 <- function(sim) {
  # ! ----- EDIT BELOW ----- ! #
  # THE BELOW TWO LINES ARE FOR INITIALATING UNIT TESTS, DELETE THEM WHEN YOU COMPILE YOUR OWN EVENT
  sim$event1Test1 <- \" this is test for event 1. \"
  sim$event1Test2 <- 999
...
", name, "Event2 = function(sim) {
  # ! ----- EDIT BELOW ----- ! #
  # THE BELOW TWO LINES ARE FOR INITIALATING UNIT TESTS, DELETE THEM WHEN YOU COMPILE YOUR OWN EVENT
  sim$event2Test1 <- \" this is test for event 2. \"
  sim$event2Test2 <- 777
