...
#'
#' @param name character vector, specify the object name
#'
#' @param class character, specify the object class
#'
...
setMethod("expectsInput",
          ...
          definition = function(name,
                                ...
                                sourceURL,
                                ...){
            returnDataframe <- data.frame(cbind(name, class, desc, sourceURL),
                                          stringsAsFactors = FALSE)
            templist <- list(...)
...
setMethod("expectsInput",
          ...
          definition = function(name,
                                ...
                                desc,
                                ...){
            return(expectsInput(name, class, desc, sourceURL = NA_character_, ...))
          })
...
setMethod("createsOutput",
          ...
          definition = function(name,
                                ...
                                desc,
                                ...){
            returnDataframe <- data.frame(cbind(name, class, desc),
                                          stringsAsFactors = FALSE)
            templist <- list(...)
            if(length(templist)>0){
              for(i in 1:length(templist)){
