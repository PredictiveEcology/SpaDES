...
```{r reproject1, eval=TRUE, echo=TRUE, cache=TRUE}
(mbReproj <- microbenchmark(times=1L,
vegMapLcc1.crsAge <- projectRaster(vegMapLcc1, crs=crs(age)),
vegMapLcc2.crsAge <- projectRaster(vegMapLcc2, crs=crs(age)),
vegMapLcc3.crsAge <- projectRaster(vegMapLcc3, crs=crs(age)))
)
...
```{r reproject2, eval=TRUE, echo=TRUE, cache=TRUE}
