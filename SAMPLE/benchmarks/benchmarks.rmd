---
title: "Benchmarking R for `SpaDES`"
...
vignette: |
  %\VignetteEngine{knitr::knitr} %\VignetteIndexEntry{Benchmarking R for SpaDES} %\VignetteDepends{SpaDES} %\VignetteKeyword{discrete event simulation} %\usepackage[utf8]{inputenc}
---
...
library(dplyr)
#path <- "~/GitHub/SpaDES/SAMPLE/benchmarks"
#path <- system.file("vignettes", package="SpaDES")
#setwd(path)
#sourceCpp(file="meanCPP.cpp")
```

```{r RcppFunctions, cache=TRUE, eval=TRUE, echo=TRUE}
#include <Rcpp.h>
...
```{r download_file, eval=TRUE, echo=TRUE, cache=TRUE}
  library(raster)  
  lcc05 <- raster("c:/shared/data/LCC2005_V1_4a.tif")
  age <- raster("c:/shared/data/age.tif")
...
```{r rasterToPolygon_py, eval=TRUE, echo=TRUE, cache=TRUE}
(mbRasterToPoly <- microbenchmark(times=1L,
...
```{r rasterToPolygon, eval=TRUE, echo=TRUE, cache=TRUE}
(mbRasterToPoly <- microbenchmark(times=1L,
...
## Links to other benchmark testing with R
#### Comparing data.table, dplyr, and pandas in Python:
https://github.com/Rdatatable/data.table/wiki/Benchmarks-%3A-Grouping

#### Comparing data.table and dplyr for split-combine-apply style analysis:
